...
Тренажер скорости печати с AI-генерацией текста, режимом памяти и PvP-гонками в реальном времени.

## Возможности
- Режимы: time, words, quote, memory (тренировка памяти)
...
- Авторизация и сохранение персональной статистики (слова, символы)
